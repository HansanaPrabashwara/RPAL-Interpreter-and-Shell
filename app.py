...
def terminal_enter_key_callback() :
    ...
    compiler_thread = threading.Thread(target = compile_terminal_command, args = (terminal_text[6 : ], terminal_listbox.size()))
...
terminal_listbox.insert(tk.END, ' RPAL Shell (0.0.1)v')
terminal_listbox.insert(tk.END, " © Copyright 2024 'Group 0820'")
terminal_listbox.insert(tk.END, ' By D.G.H.Prabashwara & I.T.M.Perera')
...
terminal_listbox.configure(font = Font_tuple)
print(terminal_text)
root.mainloop()